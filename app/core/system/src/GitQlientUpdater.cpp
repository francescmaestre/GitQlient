...
GitQlientUpdater::~GitQlientUpdater() { delete mManager; }
...
void GitQlientUpdater::showInfoMessage()
{
    ...
    {
        QString url
            = QString::fromUtf8("https://github.com/francescmaestre/GitQlient/releases/tag/v%1").arg(mLatestGitQlient);
