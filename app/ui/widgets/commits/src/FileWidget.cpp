...
void FileWidget::setIcon(const QString& icon) { mButton->setIcon(QIcon(icon)); }

QString FileWidget::text() const { return mText->text(); }

void FileWidget::setText(const QString& text) { mText->setText(text); }
