    ...
    , mFileDiff(new FileDiffWidget(mGit, mGitQlientCache, this))
{
    ...
    connect(mFileDiff, &FileDiffWidget::exitRequested, this, [this]() {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        if (status == GitWip::FileStatus::DeletedByThem)
        {
            resolution = QMessageBox::warning(
                this,
                tr("File deleted by them"),
                tr("The file has been deleted by them. Please add or remove the file to mark resolution."),
                "Remove file",
                "Add file");
        }
        else
        {
            resolution = QMessageBox::warning(
                this,
                tr("File deleted by us"),
                tr("The file has been deleted by us. Please add or remove the file to mark resolution."),
                "Remove file",
                "Add file");
        }
