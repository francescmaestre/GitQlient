...
QString GitQlientRepo::currentBranch() const { return mGitBase->getCurrentBranch(); }
...
void GitQlientRepo::showMergeView() { mStackedLayout->setCurrentIndex(mIndexMap[ControlsMainViews::Merge]); }

void GitQlientRepo::showPreviousView() { mStackedLayout->setCurrentIndex(mPreviousView); }
