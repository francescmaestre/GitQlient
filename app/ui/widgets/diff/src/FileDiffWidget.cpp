    ...
    , mViewStackedWidget(new QStackedWidget())
{
    ...
    connect(searchUnified, &QLineEdit::editingFinished, this, [this, searchUnified]() {
        DiffHelper::findString(searchUnified->text(), mUnifiedFile, this);
    });
    ...
    connect(searchNew, &QLineEdit::editingFinished, this, [this, searchNew]() {
        DiffHelper::findString(searchNew->text(), mNewFile, this);
    });
    ...
    connect(mSearchOld, &QLineEdit::editingFinished, this, [this]() {
        DiffHelper::findString(mSearchOld->text(), mOldFile, this);
    });
...
void FileDiffWidget::clear() { mNewFile->clear(); }
...
void FileDiffWidget::hideHunks() const { mHunksView->setHidden(true); }
...
void FileDiffWidget::hideBackButton() const { mBack->setVisible(true); }
...
void FileDiffWidget::endEditFile() { enterEditionMode(false); }
