...
namespace
{
    ...
    static const std::array<const char*, kTotalColors> kBorderColors{
        {"25, 65, 99",
         "36, 95, 146",
         "44, 116, 177",
         "56, 136, 205",
...
QString FileBlameWidget::getCurrentSha() const { return mCurrentSha->text(); }
...
ButtonLink* FileBlameWidget::createMessageLabel(const QString& sha, bool isFirst)
{
    ...
    connect(messageLabel, &ButtonLink::clicked, this, [this, sha]() {
        emit signalCommitSelected(sha);
    });
