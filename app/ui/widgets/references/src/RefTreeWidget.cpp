    ...
    , mSettings(std::make_unique<GitQlientSettings>(git->getGitDir()))
{
    ...
    connect(mTreeWidget, &BranchTreeWidget::signalSelectCommit, this, &RefTreeWidget::signalSelectCommit);
    connect(mTreeWidget, &BranchTreeWidget::fullReload, this, &RefTreeWidget::fullReload);
    connect(mTreeWidget, &BranchTreeWidget::logReload, this, &RefTreeWidget::logReload);
    connect(mTreeWidget, &BranchTreeWidget::signalMergeRequired, this, &RefTreeWidget::signalMergeRequired);
    connect(mTreeWidget, &BranchTreeWidget::mergeSqushRequested, this, &RefTreeWidget::mergeSqushRequested);
    connect(mTreeWidget, &BranchTreeWidget::signalPullConflict, this, &RefTreeWidget::signalPullConflict);

    connect(this, &RefTreeWidget::clearSelection, mTreeWidget, &BranchTreeWidget::clearSelection);
}

RefTreeWidget::~RefTreeWidget() { delete mDelegate; }

void RefTreeWidget::setCount(int count) { mFrame->setCount(count); }

void RefTreeWidget::reloadCurrentBranchLink() { mTreeWidget->reloadCurrentBranchLink(); }
